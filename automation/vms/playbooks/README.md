...
Spins up a local Fedora Cloud VM on libvirt (`qemu:///system`). Downloads
the official Fedora Cloud Base Generic qcow2 image (checksum-verified), creates a qcow2
...
```bash
automation/vms/scripts/provision-vm.sh my-fedora-vm -u root
```
